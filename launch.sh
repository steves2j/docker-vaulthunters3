...
if ! [[ -f "Vault Hunters 3rd Edition-alpha-0.0.3_Server.zip" ]]; then
  rm -fr config mods defaultconfigs scripts forge-*.jar start.sh *Server.zip
	curl -Lo 'Vault Hunters 3rd Edition-alpha-0.0.3_Server.zip' 'https://edge.forgecdn.net/files/4164/963/Vault Hunters 3rd Edition-alpha-0.0.3_Server.zip' && unzip -u -o 'Vault Hunters 3rd Edition-alpha-0.0.3_Server.zip' -d /data
